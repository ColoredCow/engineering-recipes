...
| Security | [malware-scan/](malware-scan/) | Static scanner, reusable CI workflow and local sweep for hidden-payload malware in repos (never executes scanned code) |
